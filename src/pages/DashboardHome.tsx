...
const DashboardHome = () => {
  ...
  const services = [
    ...
    {
      icon: PawPrint,
      label: t("dashboard.petTransport"),
      desc: t("dashboard.petTransportDesc"),
      path: "/rider/rides?service=pet_transport",
    },
  ];

  const stats = [
    { icon: Car, label: t("dashboard.totalRides"), value: "0" },
    { icon: DollarSign, label: t("dashboard.totalSpent"), value: "$0.00" },
      ...
      >
        ...
        <div className="flex items-center gap-3 pt-1">
          <Button
            ...
            className="rounded-full px-6 font-semibold shadow-[var(--shadow-gold)]"
          >
        ...
        <div className="grid grid-cols-2 gap-4">
          {services.map((service, i) => (
            <motion.button
              ...
              style={{
                boxShadow: "inset 0 1px 1px 0 hsl(0 0% 100% / 0.04), 0 2px 12px -4px hsl(0 0% 0% / 0.3)",
              }}
            >
        ...
        <div className="grid grid-cols-3 gap-3">
          {stats.map((card, i) => (
            <motion.div
              ...
              style={{
                boxShadow: "inset 0 1px 1px 0 hsl(0 0% 100% / 0.03)",
              }}
            >
              ...
              {card.helper && (
                <p className="text-[10px] text-muted-foreground/60 mt-0.5">{card.helper}</p>
              )}
            </motion.div>
          ))}
        </div>
