...
const INSTALL_PROMPT_DISMISS_KEY = "pickyou_install_prompt_dismissed_at";
const DISMISS_DURATION_MS = 24 * 60 * 60 * 1000;

function wasInstallPromptRecentlyDismissed(): boolean {
  if (typeof window === "undefined") return false;
  try {
    const dismissedAt = window.localStorage.getItem(INSTALL_PROMPT_DISMISS_KEY);
